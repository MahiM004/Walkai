...
- (void)pageChanged:(NSNotification*)notification {
    ...
    if (pageIndex == 0) {
        [UIView animateWithDuration:0.3 animations:^{
            [_signUpBtn setBackgroundColor:[UIColor colorWithRed:67.0f/255.0f green:106.0f/255.0f blue:227.0f/255.0f alpha:1]];
            [_signUpBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            [_signInBtn setBackgroundColor:[UIColor colorWithRed:67.0f/255.0f green:106.0f/255.0f blue:227.0f/255.0f alpha:1]];
            [_signInBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
            [_abtBtn setTitleColor:[UIColor colorWithRed:67.0f/255.0f green:106.0f/255.0f blue:227.0f/255.0f alpha:1] forState:UIControlStateNormal];
            self.view.backgroundColor = [UIColor whiteColor];
            _pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:67.0f/255.0f green:106.0f/255.0f blue:227.0f/255.0f alpha:1];
        }];
    }
    else if (pageIndex != 2) {
        [UIView animateWithDuration:0.3 animations:^{
            [_signUpBtn setBackgroundColor:[UIColor whiteColor]];
            [_signUpBtn setTitleColor:[UIColor colorWithRed:67.0f/255.0f green:106.0f/255.0f blue:227.0f/255.0f alpha:1] forState:UIControlStateNormal];
            [_signInBtn setBackgroundColor:[UIColor whiteColor]];
            [_signInBtn setTitleColor:[UIColor colorWithRed:67.0f/255.0f green:106.0f/255.0f blue:227.0f/255.0f alpha:1] forState:UIControlStateNormal];
